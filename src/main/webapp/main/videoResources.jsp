	...
	<span class="about-top-w3"><a  name="publicresource">资源下载 </a></span>
		...
		<div class="news-bottom">
				<div class="news-one-wthree-agile">	
						...
						<c:forEach items="${studyVideos }" var="videos">		
						<div class="col-md-12 news-left" style="border-bottom: 1px solid green;margin-top:10px"> 
						<a href="${proPath}/sdy/${videos.id}.html" target="_blank">
							<h4>资源名：${videos.videoName }</h4></a>
							<p class="para-w3-agile">${videos.videoSummary }</p>
							<c:if test="${videos.videoIfy eq 1 }">								
								<p style="color:red;">收费:${videos.videoMoney }元,<a href="${proPath}/pay.jsp" target="_blank" style="float: right;">付款方式</a></p>
							</c:if>	
							<c:if test="${!(videos.videoIfy eq 1) }">								
